...
## Einblicke und Über uns: aktuelle lokale Runde
...
Die neue Über-uns-Adresse, Artikelmetadaten, RSS und News-Sitemap sind technisch berücksichtigt. Der Veröffentlichungsablauf für zukünftige Artikel und die aktuellen Google-News-Anforderungen sind dokumentiert. Search Console wurde bis zur erforderlichen Google-Anmeldung geöffnet; tatsächliche Indexierung und Konto-Einreichungen bleiben nach Veröffentlichung zu prüfen. Eine Platzierungs- oder Aufnahmegarantie gibt es nicht.

Die Runde einschließlich der anschließenden Gestaltungsentscheidung wurde nach Durchsicht ausdrücklich für Commit und Push freigegeben. Änderungen, Vorher/Nachher-Vergleich und Prüfgrenzen: `changes-insights-2026-09-15.md`. Technischer Ablauf und offene Google-Schritte: `seo-insights-2026-09-15.md`. Öffentliche Live-Demo, Glaskarten und vollständiger Hellmodus bleiben zurückgestellt.
...
1. **Änderungsstand veröffentlichen und abgleichen.** Geprüfte Einblicke-Runde mit dem offiziellen GitHub-Profil committen und normal nach `main` pushen. GitHub-Zuordnung und identischen lokalen/entfernten Commit prüfen. Anschließend das automatische Deployment anhand der öffentlich gelieferten neuen Inhalte prüfen: drei Ansichten, Über-uns-Route, Rezan-Porträt, alte Teamweiterleitung, Sitemaps und Feed. Ein erfolgreicher Push allein gilt nicht als Nachweis eines fertigen Deployments.
2. **Google nach dem Deployment anbinden.** Im vorgesehenen Google-Konto anmelden, Domain-Property und Sitemap-Einreichungen kontrollieren. Startseite, Einblicke, Über uns, eigenen Artikel und Profil per URL-Prüfung testen. Die detaillierte Reihenfolge steht in `seo-insights-2026-09-15.md`. Keine Aufnahme- oder Platzierungsgarantie; Erstanmeldung und Kontozustand sind noch offen.
...
Die Reihenfolge ist ein Arbeitsplan, keine automatische Beauftragung der zurückgestellten Gestaltungs- oder Infrastrukturänderungen. Der aktuelle Auftrag veröffentlicht die freigegebene Einblicke-Runde und prüft ihren Stand; Google-Schritte setzen den Kontozugang voraus.
