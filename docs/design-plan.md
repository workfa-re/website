...
## Einblicke und Über uns: veröffentlichte Runde

Einblicke erhält einen ruhigeren redaktionellen Einstieg, eine kleine Glasnavigation und einheitliche Beitragskarten. Das Archiv und beide Artikeltypen teilen die Lesesprache. Die große Teamübersicht wird durch einen kurzen Verweis auf die neue Seite `/einblicke/ueber-uns` ersetzt. Dort stehen ein erster Textentwurf zur Geschichte und drei kompakte Teamkarten; die vollständigen Profile bleiben erreichbar. Rezans neu bereitgestelltes Foto ist integriert. Historische Quellentitel bleiben erhalten und der alte eigene Artikel erklärt den früheren Projektnamen.

Die neue Über-uns-Adresse, Artikelmetadaten, RSS und News-Sitemap sind technisch berücksichtigt. Der Veröffentlichungsablauf für zukünftige Artikel und die aktuellen Google-News-Anforderungen sind dokumentiert. Nach der Anmeldung durch den Nutzer wurde die Inhaberschaft für `workfa.re` in Search Console bestätigt. Beide Sitemaps sind eingereicht und gelesen: Die allgemeine Sitemap ist erfolgreich und enthält 23 erkannte Seiten. Die News-Sitemap enthält mangels aktueller eigener Nachrichten null URLs; das gemeldete fehlende Tag `url` unter `urlset` wird als Leerzustand dokumentiert. Google erlaubt eine leere News-Sitemap in Veröffentlichungspausen. Alle fünf gezielten URL-Prüfungen sind abgeschlossen: Startseite und Rezan-Profil sind bereits indexiert, beim Profil wurde zusätzlich ein gültiges Profilseite-Element erkannt. Die Anfragen für Einblicke, Über uns und den eigenen Artikel wurden erfolgreich angenommen. Die tatsächliche Aufnahme dieser drei Unterseiten ist später zu kontrollieren. Eine Platzierungs- oder Aufnahmegarantie gibt es nicht.

Die Runde einschließlich der anschließenden Gestaltungsentscheidung wurde nach Durchsicht ausdrücklich für Commit und Push freigegeben und inzwischen als „Refine insights navigation, team pages and SEO“ veröffentlicht. Commit: `c3a6a1c63c77191ae7335651bcce4cda7c8c0d06`, Autor und Committer: `r-yalcin`; der Live-Abgleich ist bestanden. Änderungen, Vorher/Nachher-Vergleich und Prüfgrenzen: `changes-insights-2026-09-15.md`. Die späteren Search-Console-Ergebnisse in diesem Plan und `seo-insights-2026-09-15.md` sind ein gesonderter Dokumentationsnachtrag und waren nicht Teil dieses Code-Commits. Öffentliche Live-Demo, Glaskarten und vollständiger Hellmodus bleiben zurückgestellt.

Anschließende Gestaltungsentscheidung: Aktuell, Alle Beiträge und Über uns bekommen einen gemeinsamen persistenten Einblicke-Hero. Nur die Inhalte unter der Navigation wechseln; separate Direktadressen bleiben erhalten. Aktuell zeigt sechs neueste Beiträge, das Archiv alle Beiträge und Über uns die kompakte Geschichte mit Team. Zusätzliche Rubrikzeilen und der doppelte Archivlink entfallen. Der Shader kehrt begrenzt auf eine ruhig auslaufende Hero-Ecke zurück. Diese Korrektur ist im aktuellen Änderungsprotokoll beschrieben.

## Nächste Schritte nach der Einblicke-Freigabe

1. **Veröffentlichung abgeschlossen.** Der geprüfte Code-Stand „Refine insights navigation, team pages and SEO“ ist bereits gepusht, dem offiziellen Profil `r-yalcin` als Autor und Committer zugeordnet und live abgeglichen. Der nachfolgende Search-Console-Dokumentationsstand ist davon getrennt; dafür wurde in dieser Dokumentationsrunde kein weiterer Commit oder Push ausgeführt.
2. **Google-Indexierung nachverfolgen.** Anmeldung, Domain-Inhaberschaft, Einreichung beider Sitemaps und alle fünf gezielten URL-Prüfungen sind erledigt. Startseite und Rezan-Profil sind indexiert; die Anfragen für Einblicke, Über uns und den eigenen Artikel wurden angenommen. Später die tatsächliche Aufnahme dieser drei Unterseiten kontrollieren. Bei einer neuen geeigneten Nachricht erneut die dann gefüllte News-Sitemap prüfen. Den besonderen Leerzustand sowie die detaillierten Ergebnisse dokumentiert `seo-insights-2026-09-15.md`. Keine Aufnahme- oder Platzierungsgarantie.
3. **Presse und Redaktion vervollständigen.** Prüfen, ob `presse@workfare.team` existiert und Nachrichten empfängt; der neue Website-Link richtet das Postfach nicht ein. Über-uns-Entwurf mit konkreten eigenen Formulierungen ergänzen, weitere echte Teamfotos bei Bedarf hinzufügen. Neue Artikel mit tatsächlichem Datum, Autor, Bild und Quellen nach dem dokumentierten Ablauf veröffentlichen.
4. **Zurückgestellte Glaskarten gezielt überarbeiten.** Informationsmenge und Abstände im Bereich „Für wen?“ reduzieren und gemeinsam auf Handy und Desktop beurteilen. Die Änderung bleibt eine eigene Runde.
5. **Hellmodus der gesamten Website planen und umsetzen.** Farben, Textkontraste, Glasflächen und Bilder in beiden Modi prüfen; dann den öffentlichen Umschalter anbinden. Die bereits vorbereitete Demo-Kopplung weiterverwenden.
6. **Öffentliche Live-Demo separat bereitstellen.** Getrennte Demo-Datenbank und Demo-Anwendung, Domain, Deployment und Sicherheitsabnahme gemäß `platform-demo.md`. Erst danach die öffentliche Einbettung freischalten. Diese Aufgabe bleibt ausdrücklich für später vorgemerkt.

Die Reihenfolge ist ein Arbeitsplan, keine automatische Beauftragung der zurückgestellten Gestaltungs- oder Infrastrukturänderungen. Die freigegebene Einblicke-Runde ist veröffentlicht und live geprüft. Google-Kontozugang, Sitemap-Einreichung und die gezielten URL-Prüfungen sind abgeschlossen; bestätigte Indexierungen und noch ausstehende Aufnahmeentscheidungen werden getrennt dokumentiert.

## Kontaktseite: lokale Umsetzung am 15. September

Die beauftragte Kontaktseite ersetzt den Platzhalter unter `/kontakt`. Vier Glasflächen führen zu Allgemein, Support, Presse und Datenschutz. Darunter zeigt ein kompaktes Verzeichnis alle Teammitglieder samt Rolle, persönlicher E-Mail und Profil-Link aus den bestehenden zentralen Teamdaten. Ein neuer Teamdatensatz wird bei der nächsten Veröffentlichung automatisch übernommen. E-Mail-Adressen lassen sich öffnen und kopieren. Der gemeinsame Header bleibt erhalten; der Footer verlinkt Kontakt, und der zusätzliche Chatblock entfällt auf dieser Seite.

Gestaltungsreferenzen, vollständige Änderungstabellen und bestandene Code-/Browserprüfungen stehen in `changes-contact-2026-09-15.md`. Nach Ansicht der Screenshots wurde die gezeigte Fassung ausdrücklich für Commit und Push freigegeben. Der abschließende Glasabgleich bindet die Kontaktkarten an dieselben Materialwerte wie Logo- und Menübutton. Die dargestellten Adressen einschließlich `support@workfare.team` und `datenschutz@workfare.team` werden mit dieser Fassung veröffentlicht. Postfächer, Weiterleitungen und Zustellung wurden nicht verändert oder bestätigt; die Prüfung am E-Mail-System bleibt offen. Die übrigen zurückgestellten Aufgaben bleiben unverändert im Plan.
